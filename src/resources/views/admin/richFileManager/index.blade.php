@extends('layouts.statplanet')
@section('css')
<link rel="stylesheet" type="text/css" href="{{asset('public/RichFilemanager/src/css/libs-main.css')}}" />
<link rel="stylesheet" type="text/css" href="{{asset('public/RichFilemanager/src/css/filemanager.min.css')}}" />
<style type="text/css">
...
@section('js')
<script src="{{ asset('public/RichFilemanager/src/js/libs-main.js') }}"></script>
<script src="{{ asset('public/RichFilemanager/src/js/filemanager.min.js') }}"></script>
<script src="{{ asset('public/RichFilemanager/config/filemanager.init.js') }}"></script>

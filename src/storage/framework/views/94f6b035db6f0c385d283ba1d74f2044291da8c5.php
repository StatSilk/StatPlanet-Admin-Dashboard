...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/RichFilemanager/src/css/libs-main.css')); ?>" />
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/RichFilemanager/src/css/filemanager.min.css')); ?>" />
<style type="text/css">
.fm-container .fm-loading-wrap {
	...
	left: 0;
	display: block;
	background: white url(../../public/RichFilemanager/images/spinner.gif) no-repeat center center;
	z-index: 999;
}
</style>
...
<script src="<?php echo e(asset('public/RichFilemanager/src/js/libs-main.js')); ?>"></script>
<script src="<?php echo e(asset('public/RichFilemanager/src/js/filemanager.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/RichFilemanager/config/filemanager.init.js')); ?>"></script>
...
<?php echo $__env->make('layouts.statplanet', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
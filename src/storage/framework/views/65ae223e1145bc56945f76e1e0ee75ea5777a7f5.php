...
<?php echo $__env->make('layouts.nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <div class="main">
        <div class="inner-heading">
            <div class="container">
                <?php echo e(trans('messages.User Groups')); ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 p-b-20">
                  ...
                  <table id="usergroup" class="display" style="width:100%">
                        ...
                        <?php $__currentLoopData = $usergroup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <th><input name="groupid" value="<?php echo e($group->id); ?>" onclick="myFunction()" type="checkbox" />
                                  <input type="hidden" id="<?php echo e($group->id); ?>" value="<?php echo e($group->name); ?>">
                                </th>
                                <td><?php echo e($group->name); ?></td>
                                <td>
                               <?php $newarr = []; ?>
                                <?php $__currentLoopData = $group->userGroupHasDashCat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dashcat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($dashcat->dashcat_detail): ?>
                                    <?php 
                ...
                <div class="col-12">
                    <a href="<?php echo e(url('/user-groups/create')); ?>" class="btn btn-secondary f-14 m-b-15">Add User Group</a>
                    ...
                    <a class="float-right">Total User Groups: <?php echo e($count); ?></a>
                </div>
        ...
        <div id="myModel" class="modal fade" tabindex="-1" role="dialog">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <form method="post" action="<?php echo e(url('/user-groups/assign-dashcat')); ?>">
